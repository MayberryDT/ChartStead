...
- [x] The Speaker Gallery embed treats the selected source-of-truth image as its visual acceptance contract: gallery composition, hierarchy, density, spacing, typography, colors, borders, portrait treatment, controls, and footer attribution match at the 1536×1024 reference viewport.
...
- [x] Speaker portraits use committed demo-safe images with deterministic URLs, consistent crops and focal treatment, and accurate alt text; do not use unstable external hotlinks. Use the approved ChartStead mark rather than generated logo artifacts.
...
- [x] Existing gallery/embed resolution, revision pinning, filters, field visibility, privacy boundaries, and focused tests continue to pass.
...
- 2026-08-14 — Tyler accepted the visual foundation; remaining functional inspector and interaction polish moved to Competition 52 and 57. Closed to `done`.
