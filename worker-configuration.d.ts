/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 00c8c04e348dc9f4b1e47895b0d1bee3)
...
interface __BaseEnv_CloudflareBindings {
	...
	EVENT_STORE: DurableObjectNamespace<import("./worker/index").EventStore>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "EventStore";
	}
	interface DemoEnv {
		ASSETS: R2Bucket;
		AUTH_DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RESEND_API_KEY" | "AUTH_EMAIL_FROM" | "AIRTABLE_ACCESS_TOKEN" | "AIRTABLE_BASE_ID">> {}
}
